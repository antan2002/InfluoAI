      ...
      <>
        <div className="mx-auto max-w-5xl px-8 sm:mt-10">
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            By using InfluoAI you confirm your acceptance of, and agree to be
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            ...
            InfluoAI application.
          </p>
          <h3 className="mb-5 text-left text-2xl font-semibold text-gray-600">
            3. Unlimited Access Software License with Termination Rights
          </h3>
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            The InfluoAI Software License facilitates the acquisition of Influo
            AI software through a single purchase, granting users unrestricted
            and perpetual access to its comprehensive functionalities. Tailored
            for independent creators, entrepreneurs, and small businesses,
            InfluoAI empowers users to create compelling web pages and online
            ...
            for the InfluoAI Software License enables users to enjoy the
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            Due to the nature of digital products, the InfluoAI boilerplate
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            It is not warranted that InfluoAI will meet your requirements or
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            InfluoAI does not give any warranty, guarantee or other term as to
            the quality, fitness for purpose or otherwise of the software.
            InfluoAI shall not be liable to you by reason of any representation
            ...
            other claims (whether caused by InfluoAI's negligence or the
            ...
            InfluoAI. InfluoAI shall not be liable or deemed to be in breach of
            ...
            clauses in this Agreement, in the event that InfluoAI are deemed
            liable to you for breach of this Agreement, you agree that Influo
            AI's liability is limited to the amount actually paid by you for
            your services or software, which amount calculated in reliance upon
            this clause. You hereby release InfluoAI from any and all
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            InfluoAI is not responsible for what the user does with the
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            As we continue to improve InfluoAI and expand our offerings, the
          ...
          <p className="mb-10 mt-5 text-justify leading-relaxed text-gray-600">
            ...
            relationship exists between you and InfluoAI as a result of your use
            of these services. You agree not to hold yourself out as a
            representative, agent or employee of InfluoAI. You agree that
            InfluoAI will not be liable by reason of any representation, act or
